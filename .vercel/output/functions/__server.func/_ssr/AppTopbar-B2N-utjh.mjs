import { t as toast, b as useQueryClient, n as notifyManager, o as noop$1, A as environmentManager, p as shouldThrowError, S as Subscribable, x as pendingThenable, y as resolveQueryBoolean, k as shallowEqualObjects, z as resolveStaleTime, B as isValidTimeout, C as timeUntilStale, D as timeoutManager, E as focusManager, F as fetchState, G as replaceData } from "./router-DvedLIcD.mjs";
...
function AppTopbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex items-center gap-3 border-b border-border bg-background/85 px-5 py-3 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "truncate text-[15px] font-semibold tracking-tight", children: title }) }),
      subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate text-xs text-muted-foreground", children: subtitle })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Plate, customer or job…" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "rounded border border-border px-1 py-0.5 font-mono text-[10px]", children: "⌘K" })
          ]
        }
      ),
      actions,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-accent" })
          ]
        }
      )
    ] })
