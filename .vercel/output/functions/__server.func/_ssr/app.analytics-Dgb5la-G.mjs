import { W as jsxRuntimeExports, r as reactExports, V as React, R as getDefaultExportFromCjs, a5 as commonjsGlobal } from "./server-B6_Oiuea.mjs";
import { u as useQuery, A as AppTopbar } from "./AppTopbar-B2N-utjh.mjs";
import { w as Route2, s as supabase } from "./router-DvedLIcD.mjs";
import { L as LoaderCircle } from "./loader-circle-B0RJ0UPi.mjs";
import { g as clsx } from "./button-CBWnG0WW.mjs";
import { i as invariant } from "./tiny-invariant-BVT9pohb.mjs";
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("invoices").select("amount, created_at, status").eq("workspace_id", workspaceId).eq("status", "paid");
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("jobs").select("created_at, service_type").eq("workspace_id", workspaceId);
      if (error) throw error;
      return [{
        d: "W1",
        v: data.length,
        mot: data.filter((j) => j.service_type?.toLowerCase().includes("mot")).length
      }];
    }
  });
  const totalRevenue = revenueData?.reduce((acc, curr) => acc + curr.v, 0) || 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppTopbar, { title: "Analytics", subtitle: "Operational insight across your workspace" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 p-5 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { title: "Revenue · last 6 months", total: `£${totalRevenue.toLocaleString()}`, children: isRevLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[260px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: revenueData, margin: {
        top: 12,
        right: 12,
        left: 0,
        bottom: 0
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tick: {
          fontSize: 11,
          fill: "var(--color-muted-foreground)"
        }, axisLine: false, tickLine: false, tickFormatter: (v) => `£${v >= 1e3 ? v / 1e3 + "k" : v}`, width: 42 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "v", fill: "var(--color-accent)", radius: [6, 6, 0, 0] })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { title: "Job Volume Trend", total: jobStats?.[0]?.v.toString() || "0", children: isJobsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[260px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: jobStats, margin: {
        top: 12,
        right: 12,
        left: 0,
        bottom: 0
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "var(--color-border)", vertical: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "d", tick: {
          fontSize: 11,
          fill: "var(--color-muted-foreground)"
        }, axisLine: false, tickLine: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tick: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { dataKey: "v", name: "Total Jobs", stroke: "var(--color-accent)", strokeWidth: 2, dot: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { dataKey: "mot", name: "MOTs", stroke: "var(--color-chart-2)", strokeWidth: 2, dot: false })
      ] }) }) })
    ] })
  ] });
}
function Card({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card shadow-soft", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-5 py-3.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tracking-tight", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tabular-nums", children: total })
    ] }),
