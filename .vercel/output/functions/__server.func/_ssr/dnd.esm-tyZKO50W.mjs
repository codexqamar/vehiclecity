import { r as reactExports, W as jsxRuntimeExports, V as React, a3 as requireReact } from "./server-B6_Oiuea.mjs";
import { B as Button, c as cn } from "./button-CBWnG0WW.mjs";
...
import { b as useQueryClient, s as supabase, t as toast, j as ReactDOM, r as reactDomExports } from "./router-DvedLIcD.mjs";
...
import { i as invariant$1 } from "./tiny-invariant-BVT9pohb.mjs";
function AddJobModal({
  ...
  const setOpen = controlledOnOpenChange !== void 0 ? controlledOnOpenChange : setInternalOpen;
  const [isLoading, setIsLoading] = reactExports.useState(false);
  const [vehicleId, setVehicleId] = reactExports.useState("");
  const [serviceType, setServiceType] = reactExports.useState("");
  const [mechanicName, setMechanicName] = reactExports.useState("");
  const [bay, setBay] = reactExports.useState("");
  ...
  reactExports.useEffect(() => {
    if (open) {
      const fetchVehicles = async () => {
        const { data } = await supabase.from("vehicles").select("id, registration, make_model, customer_id").eq("workspace_id", workspaceId).order("registration");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: trigger || /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "sm:max-w-[425px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "New workshop job" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Assign a new job to a vehicle in your workspace." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "vehicle", children: "Vehicle" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: vehicleId, onValueChange: setVehicleId, required: true, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              ...
              vehicles.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "none", disabled: true, children: "No vehicles found. Add one first." })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "mechanic", children: "Mechanic (Optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "mechanic",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "bay", children: "Bay (Optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "bay",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", disabled: isLoading || !vehicleId || !date, children: isLoading ? "Creating..." : "Create job" }) })
    ] }) })
  ] });
}
