...
import { a as Route$8, b as useQueryClient, t as toast, s as supabase } from "./router-DvedLIcD.mjs";
...
import "./popover-DTBEW-e7.mjs";
import "./chevron-right-Bp1KjpvA.mjs";
import "./plus-D-HN2_wc.mjs";
...
function Workshop() {
  ...
  const getGroupedJobs = (status) => {
    return jobs?.filter((j) => j.status === status) || [];
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full overflow-hidden no-scrollbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppTopbar, { title: "Workshop", subtitle: `Live status across your bays · ${jobs?.length || 0} active jobs`, actions: /* @__PURE__ */ jsxRuntimeExports.jsx(AddJobModal, { workspaceId }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DragDropContext, { onDragEnd, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollContainerRef, className: "flex-1 overflow-x-auto bg-surface/30 no-scrollbar relative", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-6 h-full p-6 min-w-max pr-12", children: COLS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-80 flex flex-col h-full max-h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between px-1 mb-4 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("rounded-full px-2.5 py-1 text-[11px] font-bold uppercase tracking-widest", c.tone), children: c.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-muted-foreground/40", children: getGroupedJobs(c.id).length })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectedDroppable, { droppableId: c.id, children: (provided, snapshot) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ...provided.droppableProps, ref: provided.innerRef, className: cn("flex-1 overflow-y-auto space-y-3 rounded-2xl p-2 transition-all duration-300 no-scrollbar", snapshot.isDraggingOver ? "bg-primary/5 ring-1 ring-primary/10 ring-inset" : "bg-transparent"), children: [
        getGroupedJobs(c.id).map((job, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(PublicDraggable, { draggableId: job.id, index, children: (provided2, snapshot2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: provided2.innerRef, ...provided2.draggableProps, ...provided2.dragHandleProps, className: cn("rounded-2xl border border-border bg-card p-5 shadow-sm transition-all duration-300", snapshot2.isDragging ? "shadow-2xl border-primary/40 rotate-3 scale-105 z-50 ring-2 ring-primary/20" : "hover:border-foreground/10 hover:shadow-lg active:scale-95"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plate, { reg: job.vehicle?.registration || "???", className: "scale-90 origin-left" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest bg-muted/30 px-2 py-0.5 rounded", children: job.scheduled_date ? new Date(job.scheduled_date).toLocaleDateString("en-GB", {
                day: "numeric",
                month: "short"
              }) : job.eta || "Scheduled" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-1 text-muted-foreground/40 hover:text-destructive transition-colors", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3 w-3" }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { onClick: (e) => e.stopPropagation(), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete job?" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
                      "This will permanently remove the workshop job for ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: job.vehicle?.registration }),
                      "."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { children: "Cancel" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { onClick: () => deleteJob.mutate(job.id), className: "bg-destructive text-destructive-foreground hover:bg-destructive/90", children: "Delete" })
                  ] })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[15px] font-bold text-foreground leading-tight tracking-tight", children: job.vehicle?.make_model || "Unknown Vehicle" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 text-xs text-muted-foreground/80 font-medium line-clamp-1", children: job.service_type }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex items-center justify-between border-t border-border/60 pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-black text-muted-foreground/40 uppercase tracking-[0.2em]", children: job.bay || "UNASSIGNED" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-accent/10 text-accent text-[11px] font-black ring-2 ring-accent/5", children: job.mechanic_name?.[0] || "?" })
          ] })
        ] }) }, job.id)),
        provided.placeholder,
        getGroupedJobs(c.id).length === 0 && !snapshot.isDraggingOver && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border-2 border-dashed border-border/20 p-12 text-center bg-card/5 opacity-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-widest", children: "No active jobs" }) })
      ] }) })
    ] }, c.id)) }) }) })
  ] });
}
export {
  Workshop as component
};
