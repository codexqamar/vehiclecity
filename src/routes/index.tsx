  ...
  head: () => ({
    meta: [
      { title: "VehicleCity UK — Garage management software with DVLA vehicle lookup" },
      {
        name: "description",
        content:
          "Run your UK garage on one calm, fast platform. Instant DVLA lookups, MOT reminders, workshop scheduling, invoicing and CRM — purpose-built for British workshops, MOT centres and fleets.",
      },
      { property: "og:title", content: "VehicleCity UK — Garage management software" },
      {
        property: "og:description",
        content:
          "Instant DVLA lookups, MOT reminders, workshop scheduling, invoicing and CRM. Built for UK garages.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Garage management software with DVLA vehicle lookup, MOT tracking, workshop scheduling, invoicing and CRM for UK workshops.",
        }),
      },
    ],
  }),
    ...
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 sm:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-6 text-balance text-4xl font-semibold tracking-tight text-foreground sm:text-6xl">
            ...
            <span className="relative">
              ...
              <svg
                viewBox="0 0 200 8"
                className="absolute -bottom-2 left-0 h-2 w-full text-accent/60"
                fill="none"
          ...
          <p className="mx-auto mt-6 max-w-2xl text-balance text-base text-muted-foreground sm:text-lg">
            VehicleCity brings DVLA lookups, MOT tracking, workshop scheduling, customer CRM and
            invoicing into one calm interface — designed for the way UK garages actually work.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              to="/app"
              className="group inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground shadow-elevated hover:bg-primary/90 transition"
            >
              Start 14-day trial
            ...
            <a
              href="#lookup"
              className="inline-flex items-center gap-1.5 rounded-md border border-border bg-card px-4 py-2.5 text-sm font-medium hover:border-accent/40 transition"
            >
              Try the DVLA lookup
            </a>
          </div>
          <p className="mt-4 text-xs text-muted-foreground">
            No card required · UK-hosted · GDPR compliant
          </p>
        </div>
        ...
        <div className="relative mx-auto mt-16 max-w-6xl">
          <div
            className="absolute -inset-x-12 -top-8 -bottom-8 -z-10 rounded-[2rem] bg-gradient-to-b from-accent/10 via-transparent to-transparent blur-2xl"
            aria-hidden
          />
          <DashboardMock />
        </div>
    ...
    <div className="overflow-hidden rounded-xl border border-border bg-card shadow-elevated ring-1 ring-foreground/[0.02]">
      ...
      <div className="flex items-center justify-between border-b border-border bg-surface/60 px-3.5 py-2.5">
        ...
        <div className="hidden items-center gap-1.5 rounded-md border border-border bg-card px-2 py-1 text-xs text-muted-foreground sm:flex">
          ...
          app.vehiclecity.co.uk/workshop
        </div>
        ...
        <div className="col-span-12 sm:col-span-9 p-5">
                ...
                <div className="mt-1 flex items-baseline gap-1.5">
                  ...
                  <div
                    className={cn(
                      ...
                      d.startsWith("−") ? "text-success" : "text-success",
                    )}
                  >
                    {d}
                  </div>
          ...
          <div className="mt-4 overflow-hidden rounded-lg border border-border">
            ...
            {[
              ...
              <div
                key={r.reg}
                className="grid grid-cols-[1fr_auto_auto_auto] items-center gap-3 border-b border-border px-3 py-2.5 last:border-0"
              >
                ...
                <span
                  className={cn("rounded-full border px-2 py-0.5 text-[11px] font-medium", r.tone)}
                >
                  {r.stage}
                </span>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-6 grid grid-cols-2 gap-x-8 gap-y-4 sm:grid-cols-4 lg:grid-cols-8">
          {logos.map((l) => (
            <div
              key={l}
              className="text-center text-sm font-medium tracking-tight text-muted-foreground/80"
            >
              {l}
            </div>
          ))}
...
const FEATURES = [
  {
    ...
    body: "Pull tax, MOT, fuel, engine and CO₂ from the DVLA Vehicle Enquiry Service in under a second. Cached, audited, rate-limited.",
  },
  {
    icon: ShieldCheck,
    title: "MOT & tax tracking",
    body: "Every customer vehicle monitored automatically. Reminders go out the moment expiry windows open.",
  },
  {
    icon: Users,
    title: "Customer CRM",
    body: "One profile per customer with vehicles, history, notes and conversations — never lose context again.",
  },
  {
    icon: Receipt,
    title: "Invoicing with VAT",
    body: "Generate compliant UK invoices with parts, labour and VAT. Email, download or take payment with Stripe.",
  },
  {
    icon: ClipboardList,
    title: "Workshop workflow",
    body: "Kanban-style jobs board with bays, mechanics, stages and parts gating. Drag, drop, done.",
  },
  {
    icon: Truck,
    title: "Fleet management",
    body: "Operate multi-vehicle fleets with bulk MOT, tax and service tracking, driver notes and renewal alerts.",
  },
  {
    icon: KeyRound,
    title: "Roles & permissions",
    body: "Owners, managers, mechanics, advisors — fine-grained access by branch, bay and module.",
  },
  {
    icon: Bell,
    title: "Smart reminders",
    body: "SMS and email reminders that respect quiet hours, deliverability and opt-outs.",
  },
  {
    icon: Wrench,
    title: "Service history",
    body: "A canonical service timeline per vehicle, signed off by the mechanic who did the work.",
  },
  {
    icon: BarChart3,
    title: "Operational analytics",
    body: "Bay utilisation, technician throughput, conversion, revenue mix — without exporting to a spreadsheet.",
  },
  {
    icon: BookOpen,
    title: "Digital service book",
    body: "Keep a digital record of all services and repairs, accessible by customers and mechanics.",
  },
  {
    icon: Layers,
    title: "Stock & inventory",
    body: "Track parts usage, manage supplier orders and monitor stock levels in real-time.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
            Built for the way garages actually run
          </h2>
          <p className="mt-3 text-muted-foreground">
            Stop juggling diary books, spreadsheets and four different tools. VehicleCity replaces
            them with one fast, calm workspace your whole team can use.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="grid items-start gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
              Type a plate. Know the vehicle.
            </h2>
            <p className="mt-3 text-muted-foreground">
              Connected directly to the official UK DVLA API. Validate registrations, check MOT and
              tax status, and start a job with the full vehicle profile pre-filled.
            </p>
            <ul className="mt-6 space-y-3 text-sm">
              {[
                "Sub-second response with intelligent caching",
                "Validates UK plate formats client-side",
                "Audit-logged with API key rotation",
            ...
            <div className="mt-8 rounded-lg border border-border bg-card p-4 text-xs text-muted-foreground">
              ...
              <p className="mt-1.5">
                DVSA MOT history, insurance checks, mileage verification and HPI-style provenance —
                all surfaced inline on the same card.
              </p>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
              Every vehicle, fully understood
            </h2>
            <p className="mt-3 text-muted-foreground">
              DVLA data, service history, documents and customer ownership in a single, calm record.
              The kind of profile your service advisor wishes they had.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-3 text-sm">
              {[
                ...
                >
                  <Icon className="h-4 w-4 text-muted-foreground" /> {t as string}
                </div>
              ))}
            </div>
          </div>
  ...
  const steps = [
    {
      n: "01",
      t: "Plate in",
      b: "A customer arrives or rings. Type their registration and pull the full DVLA record in under a second.",
    },
    {
      n: "02",
      t: "Job created",
      b: "Convert the lookup into a job with bay, mechanic, parts and estimated duration. Customer auto-linked.",
    },
    {
      n: "03",
      t: "Workshop runs",
      b: "The team works the kanban — diagnostics, in bay, awaiting parts, ready — with live status on shared screens.",
    },
    {
      n: "04",
      t: "Invoice & follow-up",
      b: "VAT invoice generated from job lines. Stripe payment link sent. MOT reminder scheduled automatically.",
    },
  ];
  return (
    <section className="border-b border-border bg-surface/40">
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
            From the phone to the invoice, without retyping anything
          </h2>
        </div>
...
function Testimonials() {
  const quotes = [
    {
      q: "We cut our front-desk admin in half. Plate in, job out — the team just gets it.",
      who: "Sarah Patel",
      role: "Owner, Reliable Motors",
      loc: "Manchester",
    },
    {
      q: "MOT reminders alone pay for the plan. Bookings rebooked themselves the first month.",
      who: "Daniel O'Connor",
      role: "Manager, Halton MOT Centre",
      loc: "Liverpool",
    },
    {
      q: "Finally a fleet view that doesn't feel like SAP. Our drivers actually use it.",
      who: "Aisha Begum",
      role: "Ops Lead, Northgate Fleet",
      loc: "Birmingham",
    },
  ];
  return (
            ...
            >
              ...
              <figcaption className="mt-6 flex items-center gap-3 border-t border-border pt-4">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {t.role} · <MapPin className="inline h-3 w-3" /> {t.loc}
                  </div>
                </div>
              </figcaption>
            </figure>
    ...
    <section className="relative overflow-hidden border-y border-border bg-surface">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-6 px-4 py-20 text-center sm:px-6">
        ...
        <p className="max-w-xl text-muted-foreground">
          14-day trial. No card. Bring your team and a plate.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link
            to="/auth"
            className="inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground shadow-elevated hover:bg-primary/90 transition"
          >
            Start free trial <ArrowRight className="h-4 w-4" />
          </Link>
          <a
            href="#"
            className="inline-flex items-center gap-1.5 rounded-md border border-border bg-card px-4 py-2.5 text-sm font-medium text-foreground hover:border-accent/40 transition"
          >
            Book a demo
          </a>
        </div>
