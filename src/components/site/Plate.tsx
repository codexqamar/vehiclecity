...
export function Plate({ reg, variant = "front", className }: { reg: string; variant?: "front" | "rear"; className?: string }) {
  ...
  return (
    <span className={cn(
      ...
      <span className={cn("plate-font text-black px-2.5 py-1 text-base", bg)}>
        {reg}
      </span>
    </span>
  );
