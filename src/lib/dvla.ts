...
const FIXTURES: Record<string, Omit<DvlaVehicle, "registrationNumber">> = {
  AB12CDE: {
    make: "FORD", model: "Focus ST-Line", colour: "Magnetic Grey",
    fuelType: "PETROL", engineCapacity: 1499, yearOfManufacture: 2019,
    monthOfFirstRegistration: "2019-03", taxStatus: "Taxed",
    taxDueDate: "2026-02-28", motStatus: "Valid", motExpiryDate: "2026-04-12",
    co2Emissions: 122, euroStatus: "EURO 6", markedForExport: false,
    typeApproval: "M1", wheelplan: "2 AXLE RIGID BODY",
  },
  LX21KZV: {
    make: "VOLKSWAGEN", model: "Golf GTI", colour: "Pure White",
    fuelType: "PETROL", engineCapacity: 1984, yearOfManufacture: 2021,
    monthOfFirstRegistration: "2021-07", taxStatus: "Taxed",
    taxDueDate: "2026-07-31", motStatus: "Valid", motExpiryDate: "2026-07-15",
    co2Emissions: 168, euroStatus: "EURO 6", markedForExport: false,
    typeApproval: "M1", wheelplan: "2 AXLE RIGID BODY",
  },
  EV70BYD: {
    make: "TESLA", model: "Model 3 Long Range", colour: "Midnight Silver",
    fuelType: "ELECTRICITY", engineCapacity: 0, yearOfManufacture: 2020,
    monthOfFirstRegistration: "2020-11", taxStatus: "Taxed",
    taxDueDate: "2026-11-30", motStatus: "Valid", motExpiryDate: "2026-10-22",
    co2Emissions: 0, euroStatus: "EURO 6", markedForExport: false,
    typeApproval: "M1", wheelplan: "2 AXLE RIGID BODY",
  },
  RV68OMG: {
    make: "LAND ROVER", model: "Range Rover Sport HSE", colour: "Santorini Black",
    fuelType: "DIESEL", engineCapacity: 2993, yearOfManufacture: 2018,
    monthOfFirstRegistration: "2018-09", taxStatus: "SORN",
    taxDueDate: "2025-09-01", motStatus: "Not valid", motExpiryDate: "2025-10-04",
    co2Emissions: 198, euroStatus: "EURO 6", markedForExport: false,
    typeApproval: "M1", wheelplan: "2 AXLE RIGID BODY",
  },
};
...
export async function lookupVehicle(reg: string): Promise<DvlaVehicle> {
  ...
  const models: Record<string, string> = {
    BMW: "3 Series 320d M Sport", AUDI: "A4 40 TFSI S line",
    "MERCEDES-BENZ": "C220d AMG Line", TOYOTA: "Corolla Hybrid Excel",
    VAUXHALL: "Astra SRi Turbo", NISSAN: "Qashqai N-Connecta", KIA: "Sportage GT-Line",
  };
  const seed = [...key].reduce((a, c) => a + c.charCodeAt(0), 0);
  const make = makes[seed % makes.length];
  return {
    registrationNumber: key,
    make, model: models[make],
